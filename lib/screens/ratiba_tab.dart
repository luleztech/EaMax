              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Mechi zijazo — angalia muda na point zinazohitajika',
                      style: rajdhani(12).copyWith(color: t.text2, height: 1.2),
                    ),
                  ],
                ),
              ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Ratiba itaonekana hapa admin atakapoongeza mechi',
                          textAlign: TextAlign.center,
                          style: rajdhani(12).copyWith(color: t.text2.withValues(alpha: 0.8)),
                        ),
                      ],
                    ),
                  ),
