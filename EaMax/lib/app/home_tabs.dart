...
class HomeMainTab extends StatelessWidget {
  ...
  final Future<void> Function(CarouselSlide) onPlayCarousel;
  ...
  final double cardW;
  final double cardH;
  final String Function(ChannelUi) badgeText;
              ...
              delegate: SliverChildListDelegate([
                if (initialLoading || refreshing) _ShimmerHome(cardW: cardW, cardH: cardH) else ...[
                  if (carousel.isNotEmpty)
                    EamaxCarousel(
                      items: carousel,
                      onPlaySlide: (s) => onPlayCarousel(s),
                    ),
                  const Padding(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: const Color(0x80FBBF24)),
                              ),
                              child: Row(
                                children: [
                                  Icon(Icons.star, size: 11, color: isPremiumUser ? const Color(0xFF22C55E) : AppColors.gold),
                                  const SizedBox(width: 4),
                                  Text(
                                    badgeText,
...
/// Modal overlay — `ChannelUnlockModal` in RN.
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  const Icon(Icons.lock_open, size: 40, color: Color(0xFFA855F7)),
                  const SizedBox(height: 12),
                  const Text('Fungua Channel', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
                  const SizedBox(height: 8),
                  Text(
                    channelsPremiumOnly
                  ...
                  if (!premiumOnly) ...[
                    const SizedBox(height: 16),
                    Text('Points unazohitaji: $pointsRequired pts', style: const TextStyle(color: Colors.white)),
                    Text('Una: $currentPoints pts', style: const TextStyle(color: Colors.white)),
                  ],
                  ...
                  if (canPoints)
                    FilledButton(
                      ...
                      child: const Text('Fungua kwa points'),
                    ),
                  if (!channelsPremiumOnly) ...[
                    const SizedBox(height: 8),
                    OutlinedButton(onPressed: onWatchAd, child: const Text('Tazama tangazo')),
                  ],
                  const SizedBox(height: 8),
                  TextButton(onPressed: onPremium, child: const Text('Premium')),
                  TextButton(onPressed: onClose, child: const Text('Funga')),
                ],
              ),
            ),
          ),
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  const Icon(Icons.warning_amber, size: 44, color: Color(0xFFF59E0B)),
                  const SizedBox(height: 12),
                  Text('Points hazitoshi: $channelName', textAlign: TextAlign.center, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  Text('Unahitaji $pointsRequired pts, una $userPoints.', style: const TextStyle(color: Color(0xFF9CA3AF))),
                  const SizedBox(height: 16),
                  FilledButton(
                    onPressed: () async {
                      onWatchAd();
